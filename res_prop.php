...
<link rel="stylesheet" href="res_prop.css">
...
<p style="font-size:20px;">WARNING: Non-observance of the above policies will deprive the group from the use of the facility.</p><br>
  ...
  <h2 class="title">University Vehicles</h2>
  <div class="slideshow-containers3">
    <div class="mySlides5">
    ...
    <div class="mySlides5">
      ...
      <div class="w3-display-bottommiddle w3-container ">
        <p class="label">Toyota Grandia</p>
      </div>
    </div>
  ...
  <div class="w3-container">
    ...
    <h3 style="color:#0a61aa; font-size:30px;"><strong>Information:</strong></h3>
    <h2 style="color:black; font-size:25px; margin-left:85px;">Vehicles</h2>
<ul class="mph mph-360">
  <li class="mphall">Isuzu</li>
  <li class="mphall">L-300</li>
  <li class="mphall">Toyota Pick-Up</li>
  <li class="mphall">Toyota Grandia</li>
  <li class="mphall">Toyota Innova</li>

</ul>
<p style="font-size:20px;">WARNING: These vehicles are exclusively for the PCU Community only and not for rent by the customers.</p>
    
    
    <h3 style="color:#0a61aa; font-size:30px;"><strong>Notes:</strong></h3>
<ul class="mph mph-360">
  <li class="mphall">The requesting authorized driver must surrender the proof of reservation to the Guard on Duty before departure or leaving the campus.</li>
  <li class="mphall">The Guard on Duty must submit the proof to the Office of the President upon return of the vehicle to campus, including the Time of Arrival.</li>
</ul>
<p style="font-size:20px; text-align:justify;">Please take note that you need to list all the passengers name to the General Services Office.</p>
    <br>
    <div class="reservebtn-container">
    <a href="res_formveh.php" class="reservebtn">
  Reserve Now
</a>
